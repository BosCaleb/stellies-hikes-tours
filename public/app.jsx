...
function Home() {
  ...
  return React.createElement(React.Fragment, null,
    // Hero banner
    React.createElement('section', { className: 'hero-banner' },
      React.createElement('img', { src: 'https://media.base44.com/images/public/6a9fb26545281f1567456df2/ab65ed0bb_Simonsberg.jpg', alt: 'Simonsberg mountain peaks under a bright sky', className: 'hero-banner-img' }),
      React.createElement('div', { className: 'hero-banner-inner' },
        React.createElement('div', { className: 'hero-banner-content' },
          React.createElement('span', { className: 'hero-banner-tag' }, 'Pniel · Paarl · Stellenbosch'),
          React.createElement('h1', { className: 'hero-banner-title' }, 'Walk the mountains we grew up on.'),
          React.createElement('p', { className: 'hero-banner-desc' },
          ...
          React.createElement('div', { className: 'hero-banner-actions' },
            React.createElement('a', { href: '#/book', className: 'hero-banner-btn hero-banner-btn-primary' }, 'Book a Walk'),
            React.createElement('a', { href: '#/hikes', className: 'hero-banner-btn hero-banner-btn-secondary' }, 'See all hikes'),
          ),
        ),
        React.createElement('div', { className: 'hero-banner-info' },
